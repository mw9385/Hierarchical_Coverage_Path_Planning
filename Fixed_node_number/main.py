...
# paths
parser.add_argument('--log_dir', default='./log/V_no_hierarchy_1', type=str, help='directory for the tensorboard')
parser.add_argument('--file_name', default='HCPP_V_no_hierarchy_1', help='file directory')
parser.add_argument('--test_file_name', default='test_performance/V_no_hierarchy_1/', help='test_file directory')
args = parser.parse_args()
# save args
with open('./model/HCPP/model_V_no_hierarchy_1.txt', 'w') as f:
